...
example_dat = DiseaseDivas::carbon.copy(rawdat) # Use library to get rid of duplicate functions
...
dataset_1sql <- sqldf("SELECT ID, case when Age >=40 and Age <= 59 then '40-59' when Age >59 and Age <= 69 then '60-69'when Age >69 and Age <= 79 then '70-79' else '80+' end  FROM data set_1 GROUP BY ID,
...
join_data1_sql <- sqldf("SELECT * FROM data set_1 JOIN data set_1sql on data set_1.ID=data set_1sql.ID")
