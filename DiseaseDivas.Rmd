...
```
As shown above, comparing the two plots side-by-side revealed that there was no association between mutation count severity at a biopsy site and how frequently that biopsy site was sampled in this data set. And with that, we conclude our analysis for Aim 2!
